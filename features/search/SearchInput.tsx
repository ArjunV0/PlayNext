...
function SearchIcon() {
  return (
    <svg className="size-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
...
function ClearIcon() {
  return (
    <svg className="size-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
    ...
    <div ref={wrapperRef} className="relative w-full">
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-xl border border-gray-200/60 bg-gray-50/80 py-2.5 pr-10 pl-10 text-sm text-gray-900 placeholder-gray-400 transition-all focus:border-blue-500/50 focus:bg-white focus:shadow-lg focus:shadow-blue-500/5 focus:outline-none focus:ring-1 focus:ring-blue-500/30 dark:border-gray-600/60 dark:bg-gray-800/80 dark:text-white dark:placeholder-gray-500 dark:focus:border-blue-400/50 dark:focus:bg-gray-800 dark:focus:shadow-blue-500/5"
        />
      ...
      {showDropdown && (
        <div className="absolute top-full right-0 left-0 z-50 mt-2 max-h-[400px] animate-slide-down overflow-y-auto rounded-xl border border-white/20 bg-white/90 shadow-xl backdrop-blur-xl dark:border-gray-700/50 dark:bg-gray-900/90">
